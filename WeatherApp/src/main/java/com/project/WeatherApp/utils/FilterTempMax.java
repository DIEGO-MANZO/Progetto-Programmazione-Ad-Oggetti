...
public class FilterTempMax implements FilterStats {
	...
	public JSONArray oneDay (String name1, String name2, String name3, String value) {
		...
		double average1 = city1.getDouble("Temp_Max Average");
		double average2 = city2.getDouble("Temp_Max Average");
		double average3 = city3.getDouble("Temp_Max Average");
		...
		city1.put("temp_max_average", average1);
		
		city2.put("city2", name2);
		city2.put("temp_max_average", average2);
		
		city3.put("city3", name3);
		city3.put("temp_max_average", average3);
