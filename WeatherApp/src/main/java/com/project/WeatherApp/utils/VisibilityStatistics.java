...
public class VisibilityStatistics {
	 ...
	 */
	public JSONArray dailyVisibilityStats(String city, JSONArray visibility) {
	...
	public JSONArray  oneWeekVisibilityStats(String city, JSONArray visibility) {
		...
		JSONArray oneDay = dailyVisibilityStats(city,visibility);
		JSONArray stats = new JSONArray();
	...
	public JSONArray  threeWeekVisibilityStats(String city, JSONArray visibility) {
		...
		oneWeek = oneWeekVisibilityStats(city, visibility);
